...
<head>
    ...
    <title>Roaster View Details</title>
...
<?php include('sidebar.php');?>
    ...
    <div class="main-panel">
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url();?>index.php/Worlds_coffee_admin/coffee_details">Roaster Detail</a>
                </div>
        ...
        <div class="content">
        <div class="container-fluid">
          <a class="navbar-brand" href="<?php echo base_url();?>index.php/Worlds_coffee_admin/roaster_details"><i class="fa fa-arrow-left"></i> All Roasters</a>
          <div id="roaster_view_detail" class="card mb-3">

                  <div class="middle">
                    <div class="row">
                      <div class="terms-condition roaster-view"><br>
                        <div class="text-center">
                        <img src="<?php echo base_url().$roaster_image;?>" alt="logo" class="img-fluid"/>
                         <hr><br>
                         <h1 class="text-uppercase mt-3" style="font-size: 23px;   font-weight: 600;"><?php echo $roaster_name;?><img src="images/heading-leaves.png" alt="" width="30px;"/></h1>
                         <h4><?php echo $roaster_location;?></h4><br>
                      </div>
                
               <h5 class="text-uppercase"><b>Description</b></h5> 
              <p><?php echo $description;?></p><br><br>
              <h5 class="text-uppercase"><b>Story</b></h5>
